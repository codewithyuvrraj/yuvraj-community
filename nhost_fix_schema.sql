-- ============================================
-- NHOST SCHEMA FIX - BUSINESSCONNECT
...
BEGIN
    ...
    RAISE NOTICE '⚠️  Demo user skipped due to password_hash constraint';
    RAISE NOTICE '💡 Use Nhost Auth signup to create users properly';
END
$$;